...
<!--                <a href="#" class="material-icons mdc-top-app-bar__action-item" aria-label="Upload">star_border</a>-->
    ...
    <!--    <div class="mdc-menu mdc-menu-like mdc-menu-surface">
           <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical" tabindex="-1">
           <li>
               <span class="mdc-typography mdc-typography--subtitle1" style="padding-left: 15px;">Ðã thêm vào album ?nh yêu thích nhé !</span>
           </li>
           <li class="mdc-list-item" role="menuitem">
               <button class="mdc-button" onclick="functionCloseLike()">Ðóng</button>
               <button class="mdc-button mdc-button--raised" onclick="window.location.href='#'">Ð?n album ?nh yêu thích</button>
           </li>
       </ul>
       </div> -->
